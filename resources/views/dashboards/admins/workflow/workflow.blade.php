                            ...
                            <span>
                                {{-- <div class="btn-group dropleft" style="margin-top: 5px">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="#" class="ml-1 back_textColor backbg_fourthly p-1">
                                            <i class="far fa-eye-slash"></i> Silinen İş Akışı
                                        </a>
                                    </div>
                                </div>

                                <a href="#" class="backbg_primary back_textColor content-datatable-create-button">
...
<script>
    $(document).ready(function() {
        ...
        let workflowDT = $("#workflow").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('admin/is_akisi_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        if (data.okay == 0) {
                            html +=
                                '<span class="badge_pill color_badge_success">Beklemede</span> <br>';
                        } else if (data.okay == 1) {
                            html +=
                                '<span class="badge_pill color_badge_fail">Onaylı</span> <br>';
                        } else {
                            html +=
                                '<span class="badge_pill color_badge_fail">Reddildi</span> <br>';
                        }
                        return html;
                    }
                },
                {
                    ...
                    className: 'text-center',
                    render: function(data) {
                        var url = '{{ route('admin.workflow_show', ':id') }}';
                        url = url.replace(':id', data.id);
                        var html = '';

                        // html +=
                        //     '<a class="btn mr-1 backbg_thirdly back_textColorV1"  data-toggle="tooltip" data-placement="top" title="Düzenle"><i class="fas fa-wrench"></i></a>';
                        html +=
                            '<a class="btn backbg_primary back_textColor" href="' + url +
