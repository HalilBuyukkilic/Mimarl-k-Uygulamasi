                    ...
                    <div class="card p-5 mt-3" style="background-color: white">
                        <div class="d-flex justify-content-between">
                            <span style="font-size: 22px;">
                                <i class="fas fa-dharmachakra mr-1"></i> Etkinlikler Listesi
                            </span>
                            <span>
                                <div class="btn-group dropleft" style="margin-top: 5px">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('admin.deleted.events') }}"
                                            ...
                                            <i class="far fa-eye-slash"></i> Silinen Etkinlikler
                                        </a>
                                    </div>
                                </div>

                                <a href="{{ route('admin.events_create') }}"
...
<script>
    $(document).ready(function() {
        ...
        let eventsDT = $("#events").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('admin/etkinlikler_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    className: 'text-center',
                    render: function(data) {
                        var url = '{{ route('admin.events_edit', ':id') }}';
                        url = url.replace(':id', data.id);

                        var url_ui = '{{ route('ui.event.page', ':slug') }}';
