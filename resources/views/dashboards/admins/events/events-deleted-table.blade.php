...
@section('title', 'Silinmiş Etkinlikler')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Silinmiş Etkinlikler</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card p-5 mt-3" style="background-color: white">
                        <div class="d-flex justify-content-between">
                            <span style="font-size: 22px;">
                                <i class="fas fa-dharmachakra mr-1"></i> Silinmiş Etkinlikler Listesi
                            </span>
                            <span>
...
<script>
    $(document).ready(function() {
        ...
        let eventsDT = $("#events").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('admin/silinmis_etkinlikler_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        html +=
                            '<a class="btn mr-1 backbg_secondary back_textColor restored-event" data-id=' +
                            data.id +
        ...
        $("#events").on("click", 'a.restored-event', function() {

            var event_id = $(this).data('id');

            $.ajax({
                url: "{{ route('admin.event_restored') }}",
                type: "post",
                headers: {
