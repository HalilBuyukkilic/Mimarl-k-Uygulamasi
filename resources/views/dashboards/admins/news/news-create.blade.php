            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <span style="font-size: 22px;">
                        <i class="fas fa-newspaper mr-2"></i> Yeni Haber
                    </span>
                    <span>
                ...
                <form class="form-horizontal mt-4" enctype="multipart/form-data" onsubmit="newsCreate();return false;"
                    id="news-create-form">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <textarea class="ckeditor form-control" name="content" id="news_content"></textarea>
                    </div>
...
<script type="text/javascript">
    ...
    function newsCreate() {
        ...
        axios({
            method: 'post',
            url: '{{ route('admin.news_save') }}',
            data: new FormData($('#news-create-form')[0])
        }).then(res => {

            $.confirm({
                title: res.data.status == 1 ? 'Tebrikler' : 'Hata !',
                content: res.data.status == 1 ? 'Yeni haber eklendi' :
                    'Haber eklerken bir hata meydana geldi',
            ...
            document.getElementById('news-create-form').reset();
            CKEDITOR.instances.news_content.setData('');
            newsimg.src = "{{ URL::asset('/img/default/default-image.jpg') }}";
