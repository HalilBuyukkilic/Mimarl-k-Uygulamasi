...
@section('title', 'Silinmiş Haberler')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Silinmiş Haberler</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card p-5 mt-3" style="background-color: white">
                        <div class="d-flex justify-content-between">
                            <span style="font-size: 22px;">
                                <i class="fas fa-newspaper mr-1"></i> Silinmiş Haberler Listesi
                            </span>
                            <span>
...
<script>
    $(document).ready(function() {
        ...
        let newsDT = $("#news").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('admin/silinmis_haberler_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        html +=
                            '<a class="btn mr-1 backbg_secondary back_textColor restored-news" data-id=' +
                            data.id +
        ...
        $("#news").on("click", 'a.restored-news', function() {

            var news_id = $(this).data('id');

            $.ajax({
                url: "{{ route('admin.news_restored') }}",
                type: "post",
                headers: {
