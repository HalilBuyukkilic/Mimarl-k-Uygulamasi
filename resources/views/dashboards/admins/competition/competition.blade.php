            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Yarışma</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card p-5 mt-3" style="background-color: white">
                        <div class="d-flex justify-content-between">
                            <span style="font-size: 22px;">
                                <i class="fas fa-shapes mr-1"></i> Yarışma Listesi
                            </span>
                            <span>
                                <div class="btn-group dropleft" style="margin-top: 5px">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('admin.deleted.competition') }}"
                                            class="ml-1 back_textColor backbg_fourthly p-1">
                                            <i class="far fa-eye-slash"></i> Silinen Yarışmalar
                                        </a>
                                    </div>
                                </div>

                                <a href="{{ route('admin.competition_create') }}"
                        ...
                        <table id="competition" class="table table-bordered table-striped">
                            <thead>
                                <tr>
...
<script>
    $(document).ready(function() {
        $.noConflict();
        let competitionDT = $("#competition").DataTable({
            language: {
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('admin/yarisma_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    className: 'text-center',
                    render: function(data) {
                        var url = '{{ route('admin.competition_edit', ':id') }}';
                        url = url.replace(':id', data.id);

                        var url_competition = '{{ route('admin.competition_datas', ':id') }}';
                        url_competition = url_competition.replace(':id', data.id);

                        var url_ui = '{{ route('ui.competition.page') }}';
                        ...
                        html +=
                            '<a class="btn  backbg_primary  back_textColorV1 ml-1" href="' +
                            url_competition +
                            '"    data-toggle="tooltip" data-placement="top" title="Katılım listesi"><i class="fas fa-list"></i></a>';
