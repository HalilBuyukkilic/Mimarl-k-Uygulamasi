...
@section('title', 'Silinmiş Yarışmalar')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Silinmiş Yarışmalar</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card p-5 mt-3" style="background-color: white">
                        <div class="d-flex justify-content-between">
                            <span style="font-size: 22px;">
                                <i class="fas fa-shapes mr-1"></i> Silinmiş Yarışmalar Listesi
                            </span>
                            <span>
...
<script>
    $(document).ready(function() {
        ...
        let competitionDT = $("#competition").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('admin/silinmis_yarisma_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        html +=
                            '<a class="btn mr-1 backbg_secondary back_textColor restored-competition" data-id=' +
                            data.id +
        ...
        $("#competition").on("click", 'a.restored-competition', function() {
