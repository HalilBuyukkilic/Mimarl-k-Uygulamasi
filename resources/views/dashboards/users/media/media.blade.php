                            ...
                            <div class="col-md-2 p-3">
                                <div class="card" style="width: 9rem;background-color:#eee">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('user.media.images', 'is_akisi') }}" class="card-link"><i
                            ...
                            <div class="col-md-2 p-3">
                                <div class="card" style="width: 9rem;background-color:#eee">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('user.media.images', 'konu') }}" class="card-link"><i
                                                class="fas fa-file-image" style="color:#90caf9;font-size:120px"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 p-3">
                                <div class="card" style="width: 10rem;background-color:#eee">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('user.media.docs', 'is_akisi') }}" class="card-link"><i
                            ...
                            <div class="col-md-2 p-3">
                                <div class="card" style="width: 10rem;background-color:#eee">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('user.media.docs', 'konu') }}" class="card-link"><i
                                                class="fas fa-folder-open" style="color:#e7c77a;font-size:120px"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2 p-3">
                                <div class="card" style="width: 10rem;background-color:#eee">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('user.media.docs', 'dekont') }}" class="card-link"><i
                                                class="fas fa-folder-open" style="color:#e7c77a;font-size:120px"></i></a>
                                    </div>
                                </div>
                            </div>
