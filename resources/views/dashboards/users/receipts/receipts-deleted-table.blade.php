...
@section('title', 'Silinmiş Dekontlar')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Silinmiş Dekontlar</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card p-5 mt-3" style="background-color: white">
                        <div class="d-flex justify-content-between">
                            <span style="font-size: 22px;">
                                <i class="fas fa-receipt mr-1"></i> Silinmiş Dekontlar Listesi
                            </span>
                            <span>
...
<script>
    $(document).ready(function() {
        ...
        let receiptsDT = $("#receipts").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "{{ url('uye/silinmis_dekontlar_veritablosu') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        html +=
                            '<a class="btn mr-1 backbg_secondary back_textColor restored-receipt" data-id=' +
                            data.id +
        ...
        $("#receipts").on("click", 'a.restored-receipt', function() {

            var receipt_id = $(this).data('id');

            $.ajax({
                url: "{{ route('user.receipt_restored') }}",
                type: "post",
                headers: {
