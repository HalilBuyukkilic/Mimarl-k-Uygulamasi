...
{
    function media(){
        return view('dashboards.admins.media.media');
    }
    ...
    function imagesMedia(Request $request, $modul_type){
        ...
        return view('dashboards.admins.media.media_images', compact('mediaImages','modul_type'));
    }
    ...
    function docsMedia(Request $request, $modul_type){
        ...
        return view('dashboards.admins.media.media_document', compact('docsMedia','modul_type'));
    }
